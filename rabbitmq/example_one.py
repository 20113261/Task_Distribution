...
class PikaClient(object):
    ...
    def connect(self):
        ...
        creds = pika.PlainCredentials('hourong', '1220')
        params = pika.ConnectionParameters(host='10.10.189.213',
                                           virtual_host='TaskDistribute', credentials=creds)
...
def main():
    ...
    print
    "Tornado is serving on port {0}.".format(port)
